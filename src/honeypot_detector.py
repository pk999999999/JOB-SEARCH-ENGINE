...
class HoneypotDetector:
    ...
    def _check_overlapping_jobs(self, candidate: Candidate) -> List[str]:
        ...
        Medium signal: Many jobs at the same time (3+, excluding the 2-job case
        which is handled by _check_multiple_current to avoid double-counting).
        ...
        # Only flag 3+ current jobs (2 current jobs is handled by _check_multiple_current)
